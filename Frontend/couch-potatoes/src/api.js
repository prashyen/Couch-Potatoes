...
export default function api() {
    ...
    module.signup = function (bodyValues, callback) {
        return send('post', `${backendHost}accounts/signup`, bodyValues, callback, true);
    };
    ...
    module.search = function (searchQuery, callback) {
        return send('get', `${backendHost}shows/Search?q=${searchQuery}`, null, callback);
    };

    module.getPopularShows = function (callback) {
        return send('get', `${backendHost}shows/PopularShows`, null, callback);
    };

    module.getHighlyRatedShows = function (callback) {
        return send('get', `${backendHost}shows/PopularShows?rated=True`, null, callback);
    };

    module.getShowImage = function (showId, callback) {
        return send('get', `${backendHost}shows/ShowImage?show_id=${showId}`, null, callback);
    };
    ...
    module.deleteUserShowList = function(showId, callback){
        return send('delete', `${backendHost}profiles/ShowList?show_id=${showId}`, null, callback);
    };
    module.getProfilePicture = function(callback){
        return send('get', `${backendHost}profiles/Picture`, null, callback);
    };
    module.getUserPicture = function(username, callback){
        return send('get', `${backendHost}profiles/UserProfile?username=${username}`, null, callback);
    };
    ...
    module.getShowRating = function(showId, callback){
        return send('get', `${backendHost}reviews/ShowRating?show_id=${showId}`, null, callback);
    };
    module.postReview = function(data, callback){
        return send('post', `${backendHost}reviews/Review`, data, callback);
    };
    module.deleteReview = function(showId, callback){
        return send('delete', `${backendHost}reviews/Review?show_id=${showId}`, null, callback);
    };
    module.getReviews = function(showId, callback){
        return send('get', `${backendHost}reviews/ShowReviews?show_id=${showId}`, null, callback);
    };
